...
CREATE TABLE `car` (
  ...
  `numDoors` int(11) unsigned NOT NULL,
  `trunkCapacity` int(11) unsigned NOT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `series` (
  `serieNum` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `truck` VALUES ('B5109TY',300,'G');
...
CREATE TABLE `vehicle` (
  `serieNum` int(11) unsigned NOT NULL,
  `registration` varchar(10) NOT NULL,
  `numFrame` varchar(17) NOT NULL,
  `colour` varchar(45) NOT NULL,
  `numOfSeats` int(11) unsigned NOT NULL,
...
-- Dump completed on 2022-03-31 23:15:16
